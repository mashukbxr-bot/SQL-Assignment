...
-- Create and use the specific database for the assignment
CREATE DATABASE IF NOT EXISTS PWSkills_Assignment;
USE PWSkills_Assignment;

-- Create the Employees table as per the problem statement
...
-- Insert the dummy data provided in the assignment PDF
